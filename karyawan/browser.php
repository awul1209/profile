...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">calon karyawan</div>
            </a>
            ...
            <li class="nav-item ">
        <a class="nav-link" href="browser.php">
        <i class="fas fa-home"></i>
        <span style="font-weight: normal;">browser</span>
    </a>
   ...
   <li class="nav-item ">
        <a class="nav-link" href="browser.php">
        <i class="fas fa-home"></i>
        <span style="font-weight: normal;">info selanjutnyya</span>
    </a>
                        ...
                        <div class="col-12">
                            <div class="card shadow mb-4" style="max-width: 1100px; margin: auto;">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Tab Button -->
                                    <div class="mb-3">
    <a href="browser.php" class="btn btn-light btn-sm">Perusahaan</a>
    <a href="usaha.php" class="btn btn-light btn-sm">Usaha</a>
    <a href="toko.php" class="btn btn-light btn-sm">Toko</a>
</div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php
                        $getalldata = mysqli_query($config, 'SELECT * FROM perusahaan');
                        $i = 1;
            ...
            <div class="modal-content">
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <br>
                        <button type="submit" class="btn btn-primary" name="fotobaru">Submit</button>
                    </div>
                </form>
            </div>
        </div>
