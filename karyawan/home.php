...
if (isset($_POST['login'])) {
    ...
    $cekdatabase = mysqli_query($config, "SELECT * FROM user WHERE email='$email'");
    ...
    <div class="col-lg-6">
        <div class="card o-hidden border-0 shadow-lg">
            <div class="card-body p-5">
                ...
                <hr>
                <div class="text-center">
                    <a class="small text-info" href="forgot-password.html">Lupa Password?</a>
                </div>
                <div class="text-center">
                    <a class="small text-info" href="register.html">Buat Akun Baru!</a>
                </div>
            </div>
        </div>
    </div>
